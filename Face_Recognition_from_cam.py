...
face1= face_recognition.load_image_file("antony.jpg")
face1_encoding= face_recognition.face_encodings(face1)[0]

face2= face_recognition.load_image_file("lakshman.jpeg")
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.rectangle(frame, (left, top), (right, bottom+20), color, 2)
